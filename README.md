...
[![Java](https://img.shields.io/badge/Java-8-orange)](https://github.com/easy-4-java/canal-client-plus-sdk) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)
...
```groovy
implementation 'io.github.easy4j:canal-client-plus-sdk:1.0.x.20260630-SNAPSHOT'
```
